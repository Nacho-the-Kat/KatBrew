...
public class BalanceDao extends DAOImpl<BalanceRecord, com.katbrew.entities.jooq.db.tables.pojos.Balance, Integer> {
    ...
    @Override
    public Integer getId(com.katbrew.entities.jooq.db.tables.pojos.Balance object) {
        return object.getId();
    }
     ...
     * upperInclusive</code>
     */
    public List<com.katbrew.entities.jooq.db.tables.pojos.Balance> fetchRangeOfId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.katbrew.entities.jooq.db.tables.pojos.Balance> fetchById(Integer... values) {
     ...
     */
    public com.katbrew.entities.jooq.db.tables.pojos.Balance fetchOneById(Integer value) {
     ...
     * Fetch a unique record that has <code>id = value</code>
     */
    public Optional<com.katbrew.entities.jooq.db.tables.pojos.Balance> fetchOptionalById(Integer value) {
