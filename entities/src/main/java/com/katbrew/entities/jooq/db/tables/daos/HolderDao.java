...
public class HolderDao extends DAOImpl<HolderRecord, com.katbrew.entities.jooq.db.tables.pojos.Holder, Integer> {
    ...
    @Override
    public Integer getId(com.katbrew.entities.jooq.db.tables.pojos.Holder object) {
        return object.getId();
    }
     ...
     * upperInclusive</code>
     */
    public List<com.katbrew.entities.jooq.db.tables.pojos.Holder> fetchRangeOfId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.katbrew.entities.jooq.db.tables.pojos.Holder> fetchById(Integer... values) {
     ...
     */
    public com.katbrew.entities.jooq.db.tables.pojos.Holder fetchOneById(Integer value) {
     ...
     * Fetch a unique record that has <code>id = value</code>
     */
    public Optional<com.katbrew.entities.jooq.db.tables.pojos.Holder> fetchOptionalById(Integer value) {
