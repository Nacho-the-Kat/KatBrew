...
public class TransactionRecord extends UpdatableRecordImpl<TransactionRecord> implements ITransaction {
     ...
     */
    @Override
    public void setOpError(Integer value) {
        set(12, value);
    }
     ...
     */
    public TransactionRecord(BigInteger id, Integer fkToken, String hashRev, Integer p, Integer op, BigInteger amt, BigInteger fromAddress, BigInteger toAddress, BigInteger opScore, String feeRev, String txAccept, String opAccept, Integer opError, String checkpoint, BigInteger mtsAdd, BigInteger mtsMod) {
        super(Transaction.TRANSACTION);
