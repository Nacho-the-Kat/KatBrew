...
public class Keys {
    ...
    public static final ForeignKey<TransactionRecord, CodeWordingsRecord> TRANSACTION__FK_TRANSACTION_OP_CODES_WORDINGS = Internal.createForeignKey(Transaction.TRANSACTION, DSL.name("fk_transaction_op_codes_wordings"), new TableField[] { Transaction.TRANSACTION.OP }, Keys.PK_CODE_WORDINGS, new TableField[] { CodeWordings.CODE_WORDINGS.ID }, true);
    public static final ForeignKey<TransactionRecord, CodeWordingsRecord> TRANSACTION__FK_TRANSACTION_OP_ERROR_CODES_WORDINGS = Internal.createForeignKey(Transaction.TRANSACTION, DSL.name("fk_transaction_op_error_codes_wordings"), new TableField[] { Transaction.TRANSACTION.OP_ERROR }, Keys.PK_CODE_WORDINGS, new TableField[] { CodeWordings.CODE_WORDINGS.ID }, true);
    public static final ForeignKey<TransactionRecord, CodeWordingsRecord> TRANSACTION__FK_TRANSACTION_P_CODES_WORDINGS = Internal.createForeignKey(Transaction.TRANSACTION, DSL.name("fk_transaction_p_codes_wordings"), new TableField[] { Transaction.TRANSACTION.P }, Keys.PK_CODE_WORDINGS, new TableField[] { CodeWordings.CODE_WORDINGS.ID }, true);
