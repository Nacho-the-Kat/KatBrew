...
public class TokensRecord extends UpdatableRecordImpl<TokensRecord> implements ITokens {
     ...
     */
    public TokensRecord(Integer id, String username, String password) {
        super(Tokens.TOKENS);
     ...
     * Create a detached, initialised TokensRecord
     */
    public TokensRecord(com.nacho.entities.jooq.db.tables.pojos.Tokens value) {
        super(Tokens.TOKENS);
